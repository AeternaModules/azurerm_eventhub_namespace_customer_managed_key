...
output "eventhub_namespace_customer_managed_keys_infrastructure_encryption_enabled" {
  ...
  value       = { for k, v in azurerm_eventhub_namespace_customer_managed_key.eventhub_namespace_customer_managed_keys : k => v.infrastructure_encryption_enabled }
}
output "eventhub_namespace_customer_managed_keys_key_vault_key_ids" {
  ...
  value       = { for k, v in azurerm_eventhub_namespace_customer_managed_key.eventhub_namespace_customer_managed_keys : k => v.key_vault_key_ids }
}
output "eventhub_namespace_customer_managed_keys_user_assigned_identity_id" {
  ...
  value       = { for k, v in azurerm_eventhub_namespace_customer_managed_key.eventhub_namespace_customer_managed_keys : k => v.user_assigned_identity_id }
}
